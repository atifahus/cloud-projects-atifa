...
_openssl_versions: dict[int, int] = {
    Python.slack_bot.urllib3.util.ssl_.PROTOCOL_TLS: OpenSSL.SSL.SSLv23_METHOD,  # type: ignore[attr-defined]
    Python.slack_bot.urllib3.util.ssl_.PROTOCOL_TLS_CLIENT: OpenSSL.SSL.SSLv23_METHOD,  # type: ignore[attr-defined]
...
orig_util_SSLContext = Python.slack_bot.urllib3.util.ssl_.SSLContext
...
def inject_into_urllib3() -> None:
    ...
    Python.slack_bot.urllib3.util.ssl_.SSLContext = PyOpenSSLContext  # type: ignore[assignment]
    util.IS_PYOPENSSL = True
    Python.slack_bot.urllib3.util.ssl_.IS_PYOPENSSL = True
...
def extract_from_urllib3() -> None:
    ...
    Python.slack_bot.urllib3.util.ssl_.SSLContext = orig_util_SSLContext
    util.IS_PYOPENSSL = False
    Python.slack_bot.urllib3.util.ssl_.IS_PYOPENSSL = False
...
class PyOpenSSLContext:
    ...
    def wrap_socket(
        ...
        if server_hostname and not Python.slack_bot.urllib3.util.ssl_.is_ipaddress(server_hostname):
