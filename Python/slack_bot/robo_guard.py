...
def send_message_to_slack(event, context):
    webhook_url = "https://hooks.slack.com/services/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"
    # Build Message
    try:
        message = {
...
'''
curl -X POST -H 'Content-type: application/json' --data '{"text":"Hello, World!"}' https://hooks.slack.com/services/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
Install requests in the specified folder
pip3 install --target ./slack_bot requests
'''
